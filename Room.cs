...
namespace Dungeons
{
	...
	public class Room
	{
		public List<Tile> tiles;		// The Tiles representing the room TODO - change this to ITileJoinere when implementing Door!
		public Point roomOrigin = new Point();		// This is used to locate room w.r.t. game area origin (in Mainform).
		
		Random random = new Random();
		
		public Room(Point roomOrigin)
		{
			...
			tiles[1].InitialiseTile(TileType.clear, new Point(100,0), TileSelector(), null, tiles[2], tiles[2],tiles[0]);
